...
function Sidebar({page,setPage,tradeCount,onExport,onImport,onImportCSV,onReset,user,onLogout,theme,toggleTheme,syncStatus}){
  const nav=[{id:"dashboard",icon:"⬡",label:"Dashboard"},{id:"journal",icon:"≡",label:"Trade Journal"},{id:"add",icon:"+",label:"New Trade"},{id:"calendar",icon:"📅",label:"Calendar"},{id:"goals",icon:"🎯",label:"Goals"},{id:"announcements",icon:"📰",label:"Financial News"},{id:"dailyjournal",icon:"📝",label:"Daily Journal"},{id:"stickies",icon:"📌",label:"Notes & Watchlist"},{id:"alerts",icon:"🔔",label:"Alerts"}];
